...
let ColourAssignment['Normal']          = {"GUIFG": '#C0C0C0',       "GUIBG":  'Black'}
let ColourAssignment['Visual']          = {"GUIFG": '#404040',       "GUIBG":  'Grey'}

" Comments are green
let ColourAssignment['Comment']         = {"GUIFG": '#00ffff', "TERM":   'Bold'}
...
let ColourAssignment['Constant']        = {"GUIFG": '#ff00ff',     "CTERMFG": 'Yellow',    "TERM":  'Underline'}
let ColourAssignment['String']          = {"GUIFG": '#ff00ff'}
let ColourAssignment['Character']       = {"GUIFG": '#ff00ff'}

" Preprocessor directives are bold shades of blue
let ColourAssignment['PreProc']         = {"GUIFG": '#ffff00'}
let ColourAssignment['Include']         = {"GUIFG": '#ffff00'} " preprocessor #include
let ColourAssignment['Define']          = {"GUIFG": '#ffff00'} " preprocessor #define
let ColourAssignment['Macro']           = {"GUIFG": '#ffff00'} " same as Define
let ColourAssignment['PreCondit']       = {"GUIFG": '#ffff00'} " preprocessor #if, #else, #endif, etc.

" Statements are shades of Blue
let ColourAssignment['Statement']       = {"GUIFG": '#ffff00'}
let ColourAssignment['Conditional']     = {"GUIFG": '#ffff00'} " if, then, else, endif, switch, etc.
let ColourAssignment['Repeat']          = {"GUIFG": '#ffff00'} " for, do, while, etc.
let ColourAssignment['Label']           = {"GUIFG": '#ffff00'} " case, default, etc.
let ColourAssignment['Exception']       = {"GUIFG": '#ffff00'} " try, catch, throw

" Operators (+, =, -, % etc): not defined by default C syntax
let ColourAssignment['Operator']        = {"GUIFG": '#C0C0C0'}

" Identifiers are shades of Cyan
let ColourAssignment['Identifier']      = {"GUIFG": '#ff8000'}
let ColourAssignment['Function']        = {"GUIFG": 'Maroon'}
let ColourAssignment['Method']          = {"GUIFG": 'Maroon'}

" Special additions created by mktypes.py are shades of Purple or Grey
let ColourAssignment['Class']           = {"GUIFG": 'Green'}
let ColourAssignment['DefinedName']     = {"GUIFG": '#8080ff'}
let ColourAssignment['EnumerationValue']= {"GUIFG": '#00ff00'}
let ColourAssignment['EnumerationName'] = {"GUIFG": '#00ff00'}
let ColourAssignment['Member']          = {"GUIFG": '#ff8000'}
...
let ColourAssignment['StorageClass']    = {"GUIFG": '#fFff00'} " static, register, volatile, etc.
let ColourAssignment['Structure']       = {"GUIFG": '#ffff00'} " struct, union, enum, etc.
...
let ColourAssignment['MatchParen']      = {"GUIFG": "Red"}   " Highlighting of matching parentheses
